...
import com.fastcampus.pass.passweb.controller.BulkPassRequest;
...
import com.fastcampus.pass.passweb.repository.pass.BulkPassEntity;
...
public class BulkPassService {
    ...
    public void addBulkPass(BulkPassRequest bulkPassRequest) {
        // bulkPassRequest 기반으로 passEntity 생성해 DB에 저장
